...
public abstract class ADataContainer {
	...
	public void finishLoading() {
		Logger.d(TAG, "finishLoading()");
	}
	
	public void destroy() {
		// print results
        Logger.d(TAG, "finished...");
		Logger.d(TAG, "total processed nodes: " + amountOfNodesUsed + " / " + amountOfNodesTested);
		Logger.d(TAG, "total processed ways: " + amountOfWaysUsed + " / " + amountOfWaysTested);
		Logger.d(TAG, "total processed relations: " + amountOfRelationsUsed + " / " + amountOfRelationsTested);
	}
