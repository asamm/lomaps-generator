...
public final class Const {
     ...
     */
    public static final double ADR_CITY_POLYGON_SIMPLIFICATION_DISTANCE = 50;
     ...
     */
    public static final int ADR_MAX_DISTANCE_BETWEEN_STREET_SEGMENTS = 300;

    /**
     * Ratio of distance and city radius (test max distance for founded cities
     */
    public static final int ADR_MAX_FOUNDED_CITY_DISTANCE_RADIUS_RATIO = 3;

    /**
     * Maximal diagonal length of the envelope of the street
     */
    public static final int ADR_MAX_DIAGONAL_STREET_LENGTH = 20000;
     ...
     */
    public static final int ADR_MAX_DISTANCE_UNNAMED_STREET = 200;

    /**
     * Max distance between named street and house that have defined addr:street name
     */
    public static final int ADR_MAX_DISTANCE_NAMED_STREET = 400;

    /**
     * How fare can be named street for house that have defined only place name
     */
    public static final int ADR_MAX_DISTANCE_PLACENAME_STREET = 500;


    /**
     * Minimal size of house in meters
     */
    public static final int ADR_MIN_HOUSE_WIDTH_FOR_INTERPOLATION = 4;
    ...
    // STORE GEO DATABASE PARAMETERS

    public static final int GEO_COUNTRY_POLYGON_SIMPLIFICATION_DISTANCE = 25;
}
